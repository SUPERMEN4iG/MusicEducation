...
{
    public class BaseReportStorage
    {
        public string BranchName { get; set; }
        public string CreationDateTime { get; set; }
        public string FIO { get; set; }
        public Dictionary<string, Dictionary<string, decimal>> ResultDictionary { get; set; }
        ...
        protected void InsertValues(SheetData sheetData, MergeCells mergeCells)
        {
            ...
            foreach (var item in ResultDictionary)
            {
                ...
                Row row5 = new Row() { RowIndex = countedNumber, Spans = new ListValue<StringValue>() { InnerText = "1:6" }, DyDescent = 0.25D };
                ...
                foreach (var itemStyle in item.Value)
                {
                    ...
                    Cell cell33 = new Cell() { CellReference = "C" + countedNumber2.ToString(), StyleIndex = (UInt32Value)8U };

                    Cell cell34 = new Cell() { CellReference = "D" + countedNumber2.ToString(), StyleIndex = (UInt32Value)8U, DataType = CellValues.String };

                    //TODO: Refactoring needed
                    Int32 parsedValue = decimal.ToInt32(itemStyle.Value);
                    cell34.CellValue = new CellValue(
                        (parsedValue <= 0) ?
                            ((parsedValue != 0) ? string.Format("-{0}", Math.Abs(parsedValue).ToString()) : parsedValue.ToString()) :
                            string.Format("+{0}", parsedValue)
                            );

                    Cell cell35 = new Cell() { CellReference = "E" + countedNumber2.ToString(), StyleIndex = (UInt32Value)8U };
                    Cell cell36 = new Cell() { CellReference = "F" + countedNumber2.ToString(), StyleIndex = (UInt32Value)8U };
                    ...
                    mergeCells.Append(new MergeCell() { Reference = string.Format("A{0}:C{0}", countedNumber2.ToString()) });
                    mergeCells.Append(new MergeCell() { Reference = string.Format("D{0}:F{0}", countedNumber2.ToString()) });
   ...
   //         }
        ...
        private void GenerateWorkbookStylesPart1Content(WorkbookStylesPart workbookStylesPart1)
        {
            ...
            CellFormat cellFormat3 = new CellFormat() { NumberFormatId = (UInt32Value)0U, FontId = (UInt32Value)0U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)4U, FormatId = (UInt32Value)0U, ApplyBorder = true, ApplyAlignment = true };
            Alignment alignment1 = new Alignment() { Horizontal = HorizontalAlignmentValues.Center };

            cellFormat3.Append(alignment1);

            CellFormat cellFormat4 = new CellFormat() { NumberFormatId = (UInt32Value)0U, FontId = (UInt32Value)0U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)5U, FormatId = (UInt32Value)0U, ApplyBorder = true, ApplyAlignment = true };
            Alignment alignment2 = new Alignment() { Horizontal = HorizontalAlignmentValues.Center };

            cellFormat4.Append(alignment2);

            CellFormat cellFormat5 = new CellFormat() { NumberFormatId = (UInt32Value)0U, FontId = (UInt32Value)0U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)6U, FormatId = (UInt32Value)0U, ApplyBorder = true, ApplyAlignment = true };
            Alignment alignment3 = new Alignment() { Horizontal = HorizontalAlignmentValues.Center };

            cellFormat5.Append(alignment3);
            CellFormat cellFormat6 = new CellFormat() { NumberFormatId = (UInt32Value)0U, FontId = (UInt32Value)0U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)3U, FormatId = (UInt32Value)0U, ApplyFill = true, ApplyBorder = true };

            CellFormat cellFormat7 = new CellFormat() { NumberFormatId = (UInt32Value)0U, FontId = (UInt32Value)0U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)1U, FormatId = (UInt32Value)0U, ApplyFill = true, ApplyBorder = true, ApplyAlignment = true };
            ...
            CellFormat cellFormat8 = new CellFormat() { NumberFormatId = (UInt32Value)0U, FontId = (UInt32Value)0U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)1U, FormatId = (UInt32Value)0U, ApplyFill = true, ApplyBorder = true };

            CellFormat cellFormat9 = new CellFormat() { NumberFormatId = (UInt32Value)0U, FontId = (UInt32Value)0U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)1U, FormatId = (UInt32Value)0U, ApplyFill = true, ApplyBorder = true, ApplyAlignment = true };
            ...
            CellFormat cellFormat10 = new CellFormat() { NumberFormatId = (UInt32Value)0U, FontId = (UInt32Value)0U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)2U, FormatId = (UInt32Value)0U, ApplyBorder = true, ApplyAlignment = true };
        ...
        private void GenerateWorksheetPart1Content(WorksheetPart worksheetPart1)
        {
            ...
            Selection selection1 = new Selection() { ActiveCell = "D6", SequenceOfReferences = new ListValue<StringValue>() { InnerText = "D6:F6" } };
            ...
            Column column2 = new Column() { Min = (UInt32Value)2U, Max = (UInt32Value)2U, Width = 15.42578125D, CustomWidth = true };
            Column column3 = new Column() { Min = (UInt32Value)3U, Max = (UInt32Value)3U, Width = 12.5703125D, CustomWidth = true };
            Column column4 = new Column() { Min = (UInt32Value)4U, Max = (UInt32Value)4U, Width = 10.85546875D, CustomWidth = true };
            Column column5 = new Column() { Min = (UInt32Value)5U, Max = (UInt32Value)5U, Width = 19.85546875D, CustomWidth = true };
            Column column6 = new Column() { Min = (UInt32Value)6U, Max = (UInt32Value)6U, Width = 14.5703125D, CustomWidth = true };
            ...
            Cell cell7 = new Cell() { CellReference = "A2", StyleIndex = (UInt32Value)6U, DataType = CellValues.SharedString };
            CellValue cellValue2 = new CellValue();
            cellValue2.Text = "1";

            cell7.Append(cellValue2);
            Cell cell8 = new Cell() { CellReference = "B2", StyleIndex = (UInt32Value)6U };

            Cell cell9 = new Cell() { CellReference = "C2", StyleIndex = (UInt32Value)6U, DataType = CellValues.SharedString };
            CellValue cellValue3 = new CellValue();
            cellValue3.Text = "4";

            cell9.Append(cellValue3);
            Cell cell10 = new Cell() { CellReference = "D2", StyleIndex = (UInt32Value)6U };
            Cell cell11 = new Cell() { CellReference = "E2", StyleIndex = (UInt32Value)6U };
            Cell cell12 = new Cell() { CellReference = "F2", StyleIndex = (UInt32Value)6U };
            ...
            Cell cell13 = new Cell() { CellReference = "A3", StyleIndex = (UInt32Value)7U, DataType = CellValues.SharedString };
            CellValue cellValue4 = new CellValue();
            cellValue4.Text = "2";

            cell13.Append(cellValue4);
            Cell cell14 = new Cell() { CellReference = "B3", StyleIndex = (UInt32Value)7U };

            Cell cell15 = new Cell() { CellReference = "C3", StyleIndex = (UInt32Value)6U, DataType = CellValues.SharedString };
            CellValue cellValue5 = new CellValue();
            cellValue5.Text = "5";

            cell15.Append(cellValue5);
            Cell cell16 = new Cell() { CellReference = "D3", StyleIndex = (UInt32Value)6U };
            Cell cell17 = new Cell() { CellReference = "E3", StyleIndex = (UInt32Value)6U };
            Cell cell18 = new Cell() { CellReference = "F3", StyleIndex = (UInt32Value)6U };
            ...
            Cell cell19 = new Cell() { CellReference = "A4", StyleIndex = (UInt32Value)4U, DataType = CellValues.SharedString };
            CellValue cellValue6 = new CellValue();
            cellValue6.Text = "3";

            cell19.Append(cellValue6);
            Cell cell20 = new Cell() { CellReference = "B4", StyleIndex = (UInt32Value)4U };

            Cell cell21 = new Cell() { CellReference = "C4", StyleIndex = (UInt32Value)4U, DataType = CellValues.SharedString };
            CellValue cellValue7 = new CellValue();
            cellValue7.Text = "6";

            cell21.Append(cellValue7);
            Cell cell22 = new Cell() { CellReference = "D4", StyleIndex = (UInt32Value)4U };
            Cell cell23 = new Cell() { CellReference = "E4", StyleIndex = (UInt32Value)4U };
            Cell cell24 = new Cell() { CellReference = "F4", StyleIndex = (UInt32Value)4U };
            ...
            //Cell cell25 = new Cell() { CellReference = "A5", StyleIndex = (UInt32Value)1U };
            //Cell cell26 = new Cell() { CellReference = "B5", StyleIndex = (UInt32Value)2U };
            //Cell cell27 = new Cell() { CellReference = "C5", StyleIndex = (UInt32Value)2U };
            //Cell cell28 = new Cell() { CellReference = "D5", StyleIndex = (UInt32Value)2U };
            //Cell cell29 = new Cell() { CellReference = "E5", StyleIndex = (UInt32Value)2U };
            //Cell cell30 = new Cell() { CellReference = "F5", StyleIndex = (UInt32Value)3U };
            ...
            //Cell cell31 = new Cell() { CellReference = "A6", StyleIndex = (UInt32Value)8U };
            //Cell cell32 = new Cell() { CellReference = "B6", StyleIndex = (UInt32Value)8U };
            //Cell cell33 = new Cell() { CellReference = "C6", StyleIndex = (UInt32Value)8U };
            //Cell cell34 = new Cell() { CellReference = "D6", StyleIndex = (UInt32Value)8U };
            //Cell cell35 = new Cell() { CellReference = "E6", StyleIndex = (UInt32Value)8U };
            //Cell cell36 = new Cell() { CellReference = "F6", StyleIndex = (UInt32Value)8U };
            ...
            MergeCells mergeCells1 = new MergeCells() { Count = (UInt32Value)10U };
            MergeCell mergeCell1 = new MergeCell() { Reference = "A1:F1" };
            MergeCell mergeCell2 = new MergeCell() { Reference = "A2:B2" };
            MergeCell mergeCell3 = new MergeCell() { Reference = "C2:F2" };
            MergeCell mergeCell4 = new MergeCell() { Reference = "A3:B3" };
            MergeCell mergeCell5 = new MergeCell() { Reference = "C3:F3" };
            //MergeCell mergeCell6 = new MergeCell() { Reference = "A5:F5" };
            //MergeCell mergeCell7 = new MergeCell() { Reference = "A6:C6" };
            //MergeCell mergeCell8 = new MergeCell() { Reference = "D6:F6" };
            MergeCell mergeCell9 = new MergeCell() { Reference = "A4:B4" };
            MergeCell mergeCell10 = new MergeCell() { Reference = "C4:F4" };
        ...
        private void GenerateSharedStringTablePart1Content(SharedStringTablePart sharedStringTablePart1)
        {
            ...
            Text text1 = new Text();
            text1.Text = "Расход КС за день";

            sharedStringItem1.Append(text1);

            SharedStringItem sharedStringItem2 = new SharedStringItem();
            Text text2 = new Text();
            text2.Text = "Заведение";
            ...
            Text text5 = new Text();
            text5.Text = base.BranchName;

            sharedStringItem5.Append(text5);

            SharedStringItem sharedStringItem6 = new SharedStringItem();
            Text text6 = new Text();
            text6.Text = base.CreationDateTime;
        ...
        private void SetPackageProperties(OpenXmlPackage document)
        {
            ...
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2016-05-25T14:27:35Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
