...
define(['app'], function (app) {
	...
	var authFactory = function ($http, $rootScope, $cookieStore, Base64, baseApiUrl, $cacheFactory) {
		...
		service.Register = function (username, password, confirmPassword, callback) {
			$http.post(baseApiUrl + 'auth/Register', { username: username, password: password, confirmPassword: confirmPassword })
				.success(function (response) {
					callback(response);
				});
		};
