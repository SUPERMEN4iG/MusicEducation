...
define(['app'], function (app) {
    ...
    var amChartsDirective = function ($q) {
        return {
            restrict: 'E',
            replace: true,
            scope: {
            ...
            link: function ($scope, $el) {
                ...
                $scope.$watch('options', function () {
                    console.info('$scope.$watch[options]');
                });
                ...
                $q.when($scope.options).then(function (options) {
                    ...
                    if (options.data) {
                        var renderChart = function (amChartOptions) {
                            ...
                            chart.language = o.language;
                            chart.allLabels = o.allLabels;
                            //chart.balloon.fillColor = o.graphs[0].balloonColor;
    ...
    amChartsDirective.$inject = injectParams;

    app.directive('amChart', amChartsDirective);
