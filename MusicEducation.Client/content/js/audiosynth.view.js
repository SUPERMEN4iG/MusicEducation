function AudioSynthView() {
	...
	var fnCreateKeyboard = function(keyboardElement) {
		...
		var notesArray = [
			...
			//{ note: '', wait: 400, octave: 1 },
			////{ note: '', wait: 200, octave: 1 },
		...
		//	baseWait += notesArray[i].wait;
		//	setTimeout(function () {
		//		console.log(notesArray[i]);
		//		fnPlayKeyboard({ keyCode: notesArray[i].note });
		//		setTimeout(function () {
		//			fnRemoveKeyBinding({ keyCode: notesArray[i].note });
		//		}, 200);
		//	}, baseWait);
		//}
		var baseWait = 0;
		$.each(notesArray, function (i, obj) {
			baseWait += obj.wait;
			setTimeout(function () {
				if (obj.note !== '') { 
					fnPlayKeyboard({ keyCode: obj.note.charCodeAt(0).toString() });
					setTimeout(function () {
						fnRemoveKeyBinding({ keyCode: obj.note.charCodeAt(0).toString() });
					}, 300);
				} else {
					if (obj.octave !== undefined)
					{
						console.log('OCTAVE CHANGE');
						fnChangeOctave(obj.octave);
					}
				}
			}, baseWait);
		});
		...
		//setTimeout(function () {
		//	fnPlayKeyboard({ keyCode: '84' });
		//	setTimeout(function () {
		//		fnRemoveKeyBinding({ keyCode: '84' });
		//	}, 200);
		//}, 0);
		...
		//setTimeout(function () {
		//	fnPlayKeyboard({ keyCode: '89' });
		//	setTimeout(function () {
		//		fnRemoveKeyBinding({ keyCode: '89' });
		//	}, 200);
		//}, 600);
		...
		//setTimeout(function () {
		//	fnPlayKeyboard({ keyCode: '73' });
		//	setTimeout(function () {
		//		fnRemoveKeyBinding({ keyCode: '73' });
		//	}, 200);
		//}, 1000);

		//setTimeout(function () {
		//	fnPlayKeyboard({ keyCode: '85' });
		//	setTimeout(function () {
		//		fnRemoveKeyBinding({ keyCode: '85' });
		//	}, 200);
		//}, 1200);
	};
